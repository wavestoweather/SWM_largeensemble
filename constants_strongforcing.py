...
save_directory = '/project/meteo/scratch/K.Tempest/Model_extension_large/strong_forcing_27_5000/'  # directory for saving output
...
# DA: 
np.random.seed(24)
S_for_noise_DA = np.random.normal(loc=1.5*10**-5,scale=1.5*10**-6,size=nens)
S_for_noise_DA_ = np.tile(S_for_noise_DA,(n,1))
# free-run:
S_for_noise_ff_0 = np.tile(S_for_noise_DA_[:,:split],[1,multiply])
S_for_noise_ff_1 = np.tile(S_for_noise_DA_[:,split*1:split*2],[1,multiply])
S_for_noise_ff_2 = np.tile(S_for_noise_DA_[:,split*2:split*3],[1,multiply])
S_for_noise_ff_3 = np.tile(S_for_noise_DA_[:,split*3:split*4],[1,multiply])
S_for_noise_ff_4 = np.tile(S_for_noise_DA_[:,split*4:split*5],[1,multiply])

S_for_noise_ff_ = np.concatenate((S_for_noise_ff_0,S_for_noise_ff_1,S_for_noise_ff_2,S_for_noise_ff_3,S_for_noise_ff_4), axis=1)

from msw_model_expanded_4 import * # which script do I want to use?!?!
from DA_2019 import *
...
################################################
# get start_time
parser = argparse.ArgumentParser(description='Running DA and/or free run. Input start time please.')
...
if DA==1:
    ...
    DA_init_vis_dtampss__(EnKF)
    print('finished DA in time of = '+str(DA_start-datetime.now()))

model_start_time = datetime.now()
# free model run
model_initssamp__(start_time=start_time,batch_number=batch_number,members_per_batch=members_per_batch)
